...
- **Structures** — ✅ Dungeons (cobblestone/mossy rooms with mob spawner); ✅ Mineshafts (corridors with fence+plank supports, rails, cobwebs, torches, cave spider spawners); ✅ Scattered Features (desert pyramids with TNT trap + 4 chests, jungle pyramids with tripwire/piston traps + 2 chests, swamp huts with cauldron + witch spawner); no villages, strongholds
