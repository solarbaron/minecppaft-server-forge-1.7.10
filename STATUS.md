...
230. **Cow milking** — ✅ Done (Java EntityCow.interact: bucket 325 on cow 92/mooshroom 96 → milk bucket 335; stack-aware: last bucket replaced in-hand, multiple buckets decremented with milk added to inventory, inventory-full drops item; added replaceHeldItem/decrHeldItem/addItemToInventory helpers to PlayHandler)
