...
- **Structures** — ✅ Dungeons (cobblestone/mossy rooms with mob spawner); ✅ Mineshafts (corridors with fence+plank supports, rails, cobwebs, torches, cave spider spawners); ✅ Scattered Features (desert pyramids with TNT trap + 4 chests, jungle pyramids with tripwire/piston traps + 2 chests, swamp huts with cauldron + witch spawner); ✅ Strongholds (11 piece types + corridor fallback, recursive generation, End portal room with silverfish spawner, libraries with bookshelves + chests, stonebrick/mossy/cracked/silverfish block selector, ring-based placement around spawn); no villages
