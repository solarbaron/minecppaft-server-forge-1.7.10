...
- ~~**Nether portal transit**~~ — ✅ Standing in portal 80 ticks (4s) triggers dimension transfer, Overworld↔Nether coord scaling (÷8/×8), portal search/creation in dest world, S07 Respawn, chunk streaming, potion re-send, 300-tick cooldown
