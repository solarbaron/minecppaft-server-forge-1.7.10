                                    ...
                                    if (d16 > -0.7 && d14 * d14 + d16 * d16 + d15 * d15 < 1.0) {
                                        ...
                                        if (aji3 == ajn.b || aji3 == ajn.d || aji3 == ajn.c) {
                                            if (i4 < 10) {
                                                ...
                                                ajiArray[n16] = null;
                                                if (bl5 && ajiArray[n16 - 1] == ajn.d) {
                                                    ajiArray[n16 - 1] = this.c.a((int)(n9 + n2 * 16), (int)(n8 + n3 * 16)).ai;
                                                }
                                            }
                                        }
                                    }
        ...
        for (int i2 = 0; i2 < n6; ++i2) {
            ...
            for (int i3 = 0; i3 < n7; ++i3) {
                ...
                if (this.b.nextInt(10) == 0) {
                    f4 *= this.b.nextFloat() * this.b.nextFloat() * 3.0f + 1.0f;
                }
                this.a(this.b.nextLong(), n4, n5, ajiArray, d2, d3, d4, f4, f2, f3, 0, 0, 1.0);
            }
        }
    }
}
