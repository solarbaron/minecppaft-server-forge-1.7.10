...
extends ats {
    ...
    public atm(int n2, Random random, asv asv2, int n3) {
        super(n2);
        this.g = n3;
        this.f = asv2;
    }
    ...
    public static atm a(List list, Random random, int n2, int n3, int n4, int n5, int n6) {
        asv asv2 = asv.a(n2, n3, n4, -1, 0, 0, 5, 7, 5, n5);
        if (!atm.a(asv2) || avk.a(list, asv2) != null) {
            return null;
        }
        return new atm(n6, random, asv2, n5);
    }
    ...
    public boolean a(ahb ahb2, Random random, asv asv2) {
        ...
        this.a(ahb2, asv2, 0, 2, 4, 0, 5, 4, ajn.bj, ajn.bj, false);
        this.a(ahb2, asv2, 4, 2, 4, 4, 5, 4, ajn.bj, ajn.bj, false);
