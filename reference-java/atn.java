...
extends ats {
    ...
    public atn(int n2, Random random, asv asv2, int n3) {
        super(n2);
        this.g = n3;
        this.f = asv2;
    ...
    public void a(avk avk2, List list, Random random) {
        this.b((atw)avk2, list, random, 0, 1, true);
    }

    public static atn a(List list, Random random, int n2, int n3, int n4, int n5, int n6) {
        asv asv2 = asv.a(n2, n3, n4, -1, 0, 0, 5, 7, 5, n5);
        if (!atn.a(asv2) || avk.a(list, asv2) != null) {
            return null;
        }
        return new atn(n6, random, asv2, n5);
    }
    ...
    public boolean a(ahb ahb2, Random random, asv asv2) {
        ...
        this.a(ahb2, asv2, 0, 2, 0, 0, 5, 0, ajn.bj, ajn.bj, false);
        this.a(ahb2, asv2, 0, 2, 4, 3, 5, 4, ajn.bj, ajn.bj, false);
        ...
        if (this.b) {
            ...
            n3 = this.a(2);
            n2 = this.a(3, 3);
            if (asv2.b(n2, n3, n4 = this.b(3, 3))) {
                this.b = false;
                this.a(ahb2, asv2, random, 3, 2, 3, a, 2 + random.nextInt(4));
            }
        }
