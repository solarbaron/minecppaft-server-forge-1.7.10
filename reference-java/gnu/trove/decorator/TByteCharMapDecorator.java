        ...
        return new AbstractSet<Map.Entry<Byte, Character>>(){
            ...
            public boolean contains(Object o2) {
                if (o2 instanceof Map.Entry) {
                    ...
                    return TByteCharMapDecorator.this.containsKey(k2) && TByteCharMapDecorator.this.get(k2).equals(v);
                }
                return false;
            }
            ...
            public Iterator<Map.Entry<Byte, Character>> iterator() {
                return new Iterator<Map.Entry<Byte, Character>>(){
                    ...
                    public Map.Entry<Byte, Character> next() {
                        ...
                        final Character v = iv2 == TByteCharMapDecorator.this._map.getNoEntryValue() ? null : TByteCharMapDecorator.this.wrapValue(iv2);
