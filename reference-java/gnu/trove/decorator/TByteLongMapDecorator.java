        ...
        return new AbstractSet<Map.Entry<Byte, Long>>(){
            ...
            public boolean contains(Object o2) {
                if (o2 instanceof Map.Entry) {
                    ...
                    return TByteLongMapDecorator.this.containsKey(k2) && TByteLongMapDecorator.this.get(k2).equals(v);
                }
                return false;
            }
            ...
            public Iterator<Map.Entry<Byte, Long>> iterator() {
                return new Iterator<Map.Entry<Byte, Long>>(){
                    ...
                    public Map.Entry<Byte, Long> next() {
                        ...
                        final Long v = iv2 == TByteLongMapDecorator.this._map.getNoEntryValue() ? null : TByteLongMapDecorator.this.wrapValue(iv2);
