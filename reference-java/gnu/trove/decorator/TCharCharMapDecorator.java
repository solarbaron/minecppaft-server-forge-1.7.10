        ...
        return new AbstractSet<Map.Entry<Character, Character>>(){
            ...
            public boolean contains(Object o2) {
                if (o2 instanceof Map.Entry) {
                    ...
                    return TCharCharMapDecorator.this.containsKey(k2) && TCharCharMapDecorator.this.get(k2).equals(v);
                }
                return false;
            }
            ...
            public Iterator<Map.Entry<Character, Character>> iterator() {
                return new Iterator<Map.Entry<Character, Character>>(){
                    ...
                    public Map.Entry<Character, Character> next() {
                        ...
                        final Character v = iv2 == TCharCharMapDecorator.this._map.getNoEntryValue() ? null : TCharCharMapDecorator.this.wrapValue(iv2);
