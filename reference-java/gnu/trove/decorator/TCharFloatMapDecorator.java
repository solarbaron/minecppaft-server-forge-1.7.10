        ...
        return new AbstractSet<Map.Entry<Character, Float>>(){
            ...
            public boolean contains(Object o2) {
                if (o2 instanceof Map.Entry) {
                    ...
                    return TCharFloatMapDecorator.this.containsKey(k2) && TCharFloatMapDecorator.this.get(k2).equals(v);
                }
                return false;
            }
            ...
            public Iterator<Map.Entry<Character, Float>> iterator() {
                return new Iterator<Map.Entry<Character, Float>>(){
                    ...
                    public Map.Entry<Character, Float> next() {
                        ...
                        final Float v = iv2 == TCharFloatMapDecorator.this._map.getNoEntryValue() ? null : TCharFloatMapDecorator.this.wrapValue(iv2);
