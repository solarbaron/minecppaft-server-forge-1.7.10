        ...
        return new AbstractSet<Map.Entry<Character, Short>>(){
            ...
            public boolean contains(Object o2) {
                if (o2 instanceof Map.Entry) {
                    ...
                    return TCharShortMapDecorator.this.containsKey(k2) && TCharShortMapDecorator.this.get(k2).equals(v);
                }
                return false;
            }
            ...
            public Iterator<Map.Entry<Character, Short>> iterator() {
                return new Iterator<Map.Entry<Character, Short>>(){
                    ...
                    public Map.Entry<Character, Short> next() {
                        ...
                        final Short v = iv2 == TCharShortMapDecorator.this._map.getNoEntryValue() ? null : TCharShortMapDecorator.this.wrapValue(iv2);
