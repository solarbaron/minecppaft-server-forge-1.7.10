        ...
        return new AbstractSet<Map.Entry<Double, Double>>(){
            ...
            public boolean contains(Object o2) {
                if (o2 instanceof Map.Entry) {
                    ...
                    return TDoubleDoubleMapDecorator.this.containsKey(k2) && TDoubleDoubleMapDecorator.this.get(k2).equals(v);
                }
                return false;
            }
            ...
            public Iterator<Map.Entry<Double, Double>> iterator() {
                return new Iterator<Map.Entry<Double, Double>>(){
                    ...
                    public Map.Entry<Double, Double> next() {
                        ...
                        final Double v = iv2 == TDoubleDoubleMapDecorator.this._map.getNoEntryValue() ? null : TDoubleDoubleMapDecorator.this.wrapValue(iv2);
