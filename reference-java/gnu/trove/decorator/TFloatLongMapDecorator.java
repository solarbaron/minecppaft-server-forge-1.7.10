        ...
        return new AbstractSet<Map.Entry<Float, Long>>(){
            ...
            public boolean contains(Object o2) {
                if (o2 instanceof Map.Entry) {
                    ...
                    return TFloatLongMapDecorator.this.containsKey(k2) && TFloatLongMapDecorator.this.get(k2).equals(v);
                }
                return false;
            }
            ...
            public Iterator<Map.Entry<Float, Long>> iterator() {
                return new Iterator<Map.Entry<Float, Long>>(){
                    ...
                    public Map.Entry<Float, Long> next() {
                        ...
                        final Long v = iv2 == TFloatLongMapDecorator.this._map.getNoEntryValue() ? null : TFloatLongMapDecorator.this.wrapValue(iv2);
