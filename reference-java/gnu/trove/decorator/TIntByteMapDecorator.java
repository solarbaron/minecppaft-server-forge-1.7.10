        ...
        return new AbstractSet<Map.Entry<Integer, Byte>>(){
            ...
            public boolean contains(Object o2) {
                if (o2 instanceof Map.Entry) {
                    ...
                    return TIntByteMapDecorator.this.containsKey(k2) && TIntByteMapDecorator.this.get(k2).equals(v);
                }
                return false;
            }
            ...
            public Iterator<Map.Entry<Integer, Byte>> iterator() {
                return new Iterator<Map.Entry<Integer, Byte>>(){
                    ...
                    public Map.Entry<Integer, Byte> next() {
                        ...
                        final Byte v = iv2 == TIntByteMapDecorator.this._map.getNoEntryValue() ? null : TIntByteMapDecorator.this.wrapValue(iv2);
