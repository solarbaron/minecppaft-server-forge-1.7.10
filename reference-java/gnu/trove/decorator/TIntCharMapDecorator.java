        ...
        return new AbstractSet<Map.Entry<Integer, Character>>(){
            ...
            public boolean contains(Object o2) {
                if (o2 instanceof Map.Entry) {
                    ...
                    return TIntCharMapDecorator.this.containsKey(k2) && TIntCharMapDecorator.this.get(k2).equals(v);
                }
                return false;
            }
            ...
            public Iterator<Map.Entry<Integer, Character>> iterator() {
                return new Iterator<Map.Entry<Integer, Character>>(){
                    ...
                    public Map.Entry<Integer, Character> next() {
                        ...
                        final Character v = iv2 == TIntCharMapDecorator.this._map.getNoEntryValue() ? null : TIntCharMapDecorator.this.wrapValue(iv2);
