        ...
        return new AbstractSet<Map.Entry<Long, Integer>>(){
            ...
            public boolean contains(Object o2) {
                if (o2 instanceof Map.Entry) {
                    ...
                    return TLongIntMapDecorator.this.containsKey(k2) && TLongIntMapDecorator.this.get(k2).equals(v);
                }
                return false;
            }
            ...
            public Iterator<Map.Entry<Long, Integer>> iterator() {
                return new Iterator<Map.Entry<Long, Integer>>(){
                    ...
                    public Map.Entry<Long, Integer> next() {
                        ...
                        final Integer v = iv2 == TLongIntMapDecorator.this._map.getNoEntryValue() ? null : TLongIntMapDecorator.this.wrapValue(iv2);
