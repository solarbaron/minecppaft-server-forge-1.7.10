        ...
        return new AbstractSet<Map.Entry<Long, Long>>(){
            ...
            public boolean contains(Object o2) {
                if (o2 instanceof Map.Entry) {
                    ...
                    return TLongLongMapDecorator.this.containsKey(k2) && TLongLongMapDecorator.this.get(k2).equals(v);
                }
                return false;
            }
            ...
            public Iterator<Map.Entry<Long, Long>> iterator() {
                return new Iterator<Map.Entry<Long, Long>>(){
                    ...
                    public Map.Entry<Long, Long> next() {
                        ...
                        final Long v = iv2 == TLongLongMapDecorator.this._map.getNoEntryValue() ? null : TLongLongMapDecorator.this.wrapValue(iv2);
