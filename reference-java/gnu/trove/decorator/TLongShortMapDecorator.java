        ...
        return new AbstractSet<Map.Entry<Long, Short>>(){
            ...
            public boolean contains(Object o2) {
                if (o2 instanceof Map.Entry) {
                    ...
                    return TLongShortMapDecorator.this.containsKey(k2) && TLongShortMapDecorator.this.get(k2).equals(v);
                }
                return false;
            }
            ...
            public Iterator<Map.Entry<Long, Short>> iterator() {
                return new Iterator<Map.Entry<Long, Short>>(){
                    ...
                    public Map.Entry<Long, Short> next() {
                        ...
                        final Short v = iv2 == TLongShortMapDecorator.this._map.getNoEntryValue() ? null : TLongShortMapDecorator.this.wrapValue(iv2);
