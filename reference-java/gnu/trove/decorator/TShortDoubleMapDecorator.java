        ...
        return new AbstractSet<Map.Entry<Short, Double>>(){
            ...
            public boolean contains(Object o2) {
                if (o2 instanceof Map.Entry) {
                    ...
                    return TShortDoubleMapDecorator.this.containsKey(k2) && TShortDoubleMapDecorator.this.get(k2).equals(v);
                }
                return false;
            }
            ...
            public Iterator<Map.Entry<Short, Double>> iterator() {
                return new Iterator<Map.Entry<Short, Double>>(){
                    ...
                    public Map.Entry<Short, Double> next() {
                        ...
                        final Double v = iv2 == TShortDoubleMapDecorator.this._map.getNoEntryValue() ? null : TShortDoubleMapDecorator.this.wrapValue(iv2);
