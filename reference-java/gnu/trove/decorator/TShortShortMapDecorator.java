        ...
        return new AbstractSet<Map.Entry<Short, Short>>(){
            ...
            public boolean contains(Object o2) {
                if (o2 instanceof Map.Entry) {
                    ...
                    return TShortShortMapDecorator.this.containsKey(k2) && TShortShortMapDecorator.this.get(k2).equals(v);
                }
                return false;
            }
            ...
            public Iterator<Map.Entry<Short, Short>> iterator() {
                return new Iterator<Map.Entry<Short, Short>>(){
                    ...
                    public Map.Entry<Short, Short> next() {
                        ...
                        final Short v = iv2 == TShortShortMapDecorator.this._map.getNoEntryValue() ? null : TShortShortMapDecorator.this.wrapValue(iv2);
