...
Serializable {
    ...
    public TSynchronizedByteCollection(TByteCollection c2) {
        if (c2 == null) {
    ...
    public TSynchronizedByteCollection(TByteCollection c2, Object mutex) {
        this.c = c2;
        this.mutex = mutex;
    }
