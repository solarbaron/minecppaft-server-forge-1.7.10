...
Serializable {
    ...
    public TSynchronizedDoubleObjectMap(TDoubleObjectMap<V> m2) {
        if (m2 == null) {
    ...
    public TSynchronizedDoubleObjectMap(TDoubleObjectMap<V> m2, Object mutex) {
        this.m = m2;
        this.mutex = mutex;
    }
    ...
    public boolean equals(Object o2) {
        Object object = this.mutex;
        synchronized (object) {
            return ((Object)this.m).equals(o2);
        }
    }
