...
Serializable {
    ...
    public TSynchronizedFloatCollection(TFloatCollection c2) {
        if (c2 == null) {
    ...
    public TSynchronizedFloatCollection(TFloatCollection c2, Object mutex) {
        this.c = c2;
        this.mutex = mutex;
    }
     ...
     */
    @Override
    public boolean contains(float o2) {
        Object object = this.mutex;
        synchronized (object) {
     ...
     */
    @Override
    public boolean remove(float o2) {
        Object object = this.mutex;
        synchronized (object) {
