...
Serializable {
    ...
    public TSynchronizedIntCollection(TIntCollection c2) {
        if (c2 == null) {
    ...
    public TSynchronizedIntCollection(TIntCollection c2, Object mutex) {
        this.c = c2;
        this.mutex = mutex;
    }
