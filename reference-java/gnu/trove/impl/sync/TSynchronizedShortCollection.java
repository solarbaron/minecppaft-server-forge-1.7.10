...
Serializable {
    ...
    public TSynchronizedShortCollection(TShortCollection c2) {
        if (c2 == null) {
    ...
    public TSynchronizedShortCollection(TShortCollection c2, Object mutex) {
        this.c = c2;
        this.mutex = mutex;
    }
     ...
     */
    @Override
    public boolean contains(short o2) {
        Object object = this.mutex;
        synchronized (object) {
     ...
     */
    @Override
    public boolean remove(short o2) {
        Object object = this.mutex;
        synchronized (object) {
            return this.c.remove(o2);
        }
    }
