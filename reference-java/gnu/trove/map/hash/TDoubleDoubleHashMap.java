...
Externalizable {
    ...
    implements TDoubleCollection {
        ...
        public boolean remove(double entry) {
            ...
            while (i2-- > 0) {
                ...
                TDoubleDoubleHashMap.this.removeAt(i2);
                return true;
            }
            return false;
        }
    ...
    implements TDoubleSet {
        ...
        public boolean equals(Object other) {
            ...
            int i2 = TDoubleDoubleHashMap.this._states.length;
            while (i2-- > 0) {
                if (TDoubleDoubleHashMap.this._states[i2] != 1 || that.contains(TDoubleDoubleHashMap.this._set[i2])) continue;
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            ...
            int i2 = TDoubleDoubleHashMap.this._states.length;
            while (i2-- > 0) {
                if (TDoubleDoubleHashMap.this._states[i2] != 1) continue;
                hashcode += HashFunctions.hash(TDoubleDoubleHashMap.this._set[i2]);
            }
            return hashcode;
        }
