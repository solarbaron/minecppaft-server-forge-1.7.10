...
Externalizable {
    ...
    implements TLongCollection {
        ...
        public boolean remove(long entry) {
            ...
            while (i2-- > 0) {
                ...
                TFloatLongHashMap.this.removeAt(i2);
                return true;
            }
            return false;
        }
    ...
    implements TFloatSet {
        ...
        public boolean equals(Object other) {
            ...
            int i2 = TFloatLongHashMap.this._states.length;
            while (i2-- > 0) {
                if (TFloatLongHashMap.this._states[i2] != 1 || that.contains(TFloatLongHashMap.this._set[i2])) continue;
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            ...
            int i2 = TFloatLongHashMap.this._states.length;
            while (i2-- > 0) {
                if (TFloatLongHashMap.this._states[i2] != 1) continue;
                hashcode += HashFunctions.hash(TFloatLongHashMap.this._set[i2]);
            }
            return hashcode;
        }
