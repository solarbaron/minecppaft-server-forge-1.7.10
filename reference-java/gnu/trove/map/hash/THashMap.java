...
Externalizable {
    ...
    public boolean containsValue(Object val) {
        ...
        if (null == val) {
            ...
            int i3 = vals.length;
            while (i3-- > 0) {
                if (set[i3] == FREE || set[i3] == REMOVED || val != vals[i3] && !this.equals(val, vals[i3])) continue;
                return true;
            }
        }
        return false;
    ...
    implements Map.Entry<K, V> {
        ...
        public V setValue(V o2) {
            ...
            THashMap.this._values[this.index] = o2;
            this.val = o2;
            return retval;
        }
    ...
    extends MapBackedView<V> {
        ...
        public boolean removeElement(V value) {
            ...
            int i2 = values.length;
            while (i2-- > 0) {
                if ((set[i2] == TObjectHash.FREE || set[i2] == TObjectHash.REMOVED || value != values[i2]) && (null == values[i2] || !THashMap.this.equals(values[i2], value))) continue;
