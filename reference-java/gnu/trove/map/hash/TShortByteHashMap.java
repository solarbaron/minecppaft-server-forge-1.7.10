...
Externalizable {
    ...
    public byte adjustOrPutValue(short key, byte adjust_amount, byte put_amount) {
        ...
        if (index < 0) {
            ...
            byte by2 = (byte)(this._values[n2] + adjust_amount);
            this._values[n2] = by2;
            newValue = by2;
            isNewMapping = false;
        } else {
    ...
    implements TByteCollection {
        ...
        public boolean remove(byte entry) {
            ...
            while (i2-- > 0) {
                ...
                TShortByteHashMap.this.removeAt(i2);
                return true;
            }
            return false;
        }
    ...
    implements TShortSet {
        ...
        public boolean equals(Object other) {
            ...
            int i2 = TShortByteHashMap.this._states.length;
            while (i2-- > 0) {
                if (TShortByteHashMap.this._states[i2] != 1 || that.contains(TShortByteHashMap.this._set[i2])) continue;
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            ...
            int i2 = TShortByteHashMap.this._states.length;
            while (i2-- > 0) {
                if (TShortByteHashMap.this._states[i2] != 1) continue;
                hashcode += HashFunctions.hash(TShortByteHashMap.this._set[i2]);
            }
            return hashcode;
        }
