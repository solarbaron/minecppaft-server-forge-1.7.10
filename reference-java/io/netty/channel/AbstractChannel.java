        ...
        private void register0(ChannelPromise promise) {
            block4: {
                try {
                    ...
                    this.closeForcibly();
                    AbstractChannel.this.closeFuture.setClosed();
                    if (promise.tryFailure(t2)) break block4;
                    logger.warn("Tried to fail the registration promise, but it is complete already. Swallowing the cause of the registration failure:", t2);
                }
            }
        }
