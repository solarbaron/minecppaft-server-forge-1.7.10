...
Serializable {
    ...
    static final <K, V> boolean casTabAt(Node<K, V>[] tab, int i2, Node<K, V> c2, Node<K, V> v) {
        return U.compareAndSwapObject(tab, ((long)i2 << ASHIFT) + ABASE, c2, v);
    }

    static final <K, V> void setTabAt(Node<K, V>[] tab, int i2, Node<K, V> v) {
        U.putObjectVolatile(tab, ((long)i2 << ASHIFT) + ABASE, v);
    }
    ...
    public String toString() {
        ...
        if (p2 != null) {
            while (true) {
                ...
                sb2.append('=');
                sb2.append((Object)(v == this ? "(this Map)" : v));
                p2 = it2.advance();
                if (p2 == null) break;
                sb2.append(',').append(' ');
            }
    ...
    public boolean equals(Object o2) {
        if (o2 != this) {
            ...
            for (Map.Entry e2 : m2.entrySet()) {
                ...
                if (mk2 != null && (mv2 = e2.getValue()) != null && (v = this.get(mk2)) != null && (mv2 == v || mv2.equals(v))) continue;
                return false;
            }
        }
        return true;
    ...
    private void readObject(ObjectInputStream s2) throws IOException, ClassNotFoundException {
        ...
        while (true) {
            ...
            if (k2 == null || v == null) break;
            p2 = new Node<Object, Object>(ConcurrentHashMapV8.spread(k2.hashCode()), k2, v, p2);
            ++size;
        }
        if (size == 0L) {
            this.sizeCtl = 0;
    ...
    private final void addCount(long x2, int check) {
        ...
        if (this.counterCells != null || !U.compareAndSwapLong(this, BASECOUNT, b2 = this.baseCount, s2 = b2 + x2)) {
            ...
            CounterHashCode hc2 = threadCounterHashCode.get();
            if (hc2 == null || as2 == null || (m2 = as2.length - 1) < 0 || (a2 = as2[m2 & hc2.code]) == null || !(uncontended = U.compareAndSwapLong(a2, CELLVALUE, v = a2.value, v + x2))) {
                this.fullAddCount(x2, hc2, uncontended);
                return;
            }
            if (check <= 1) {
                return;
            ...
            synchronized (treeBin) {
                if (ConcurrentHashMapV8.tabAt(tab, i2) == f2) {
                    ...
                    if (fh2 >= 0) {
                        ...
                        TreeBin treeBin2 = lc <= 6 ? ConcurrentHashMapV8.untreeify(lo2) : (ln2 = hc2 != 0 ? new TreeBin(lo2) : t2);
                        hn = hc2 <= 6 ? ConcurrentHashMapV8.untreeify(hi2) : (lc != 0 ? new TreeBin(hi2) : t2);
                        ConcurrentHashMapV8.setTabAt(nextTab, i2, ln2);
                        ConcurrentHashMapV8.setTabAt(nextTab, i2 + n2, hn);
                        ConcurrentHashMapV8.setTabAt(tab, i2, fwd);
                        advance = true;
     ...
     * WARNING - Removed try catching itself - possible behaviour change.
     */
    private final void fullAddCount(long x2, CounterHashCode hc2, boolean wasUncontended) {
        int h2;
        if (hc2 == null) {
            hc2 = new CounterHashCode();
            int s2 = counterHashCodeGenerator.addAndGet(1640531527);
            hc2.code = s2 == 0 ? 1 : s2;
            h2 = hc2.code;
            threadCounterHashCode.set(hc2);
        } else {
            h2 = hc2.code;
        }
        ...
        while (true) {
            ...
            if (this.counterCells != null && (n2 = as2.length) > 0) {
                ...
                if (a2 == null) {
                    ...
                    v = a2.value;
                    if (U.compareAndSwapLong(a2, CELLVALUE, v, v + x2)) break;
            ...
            v = this.baseCount;
            if (U.compareAndSwapLong(this, BASECOUNT, v, v + x2)) break;
        }
        hc2.code = h2;
    }
    ...
    extends BulkTask<K, V, U> {
        ...
        public final void compute() {
            ...
            if (transformer != null && (reducer = this.reducer) != null) {
                ...
                Object r2 = null;
                while ((p2 = this.advance()) != null) {
                    U u = transformer.apply(p2.key, p2.val);
                    if (u == null) continue;
                    r2 = r2 == null ? u : reducer.apply(r2, u);
                }
                this.result = r2;
                for (CountedCompleter<?> c2 = this.firstComplete(); c2 != null; c2 = c2.nextComplete()) {
    ...
    extends BulkTask<K, V, V> {
        ...
        public final void compute() {
            ...
            if (reducer != null) {
                ...
                while ((p2 = this.advance()) != null) {
                    Object v = p2.val;
                    r2 = r2 == null ? v : reducer.apply(r2, v);
                }
                this.result = r2;
                for (CountedCompleter<?> c2 = this.firstComplete(); c2 != null; c2 = c2.nextComplete()) {
    ...
    extends BulkTask<K, V, K> {
        ...
        public final void compute() {
            ...
            if (reducer != null) {
                ...
                while ((p2 = this.advance()) != null) {
                    Object u = p2.key;
                    r2 = r2 == null ? u : (u == null ? r2 : reducer.apply(r2, u));
                }
                this.result = r2;
                for (CountedCompleter<?> c2 = this.firstComplete(); c2 != null; c2 = c2.nextComplete()) {
        ...
        public final void compute() {
            ...
            if (searchFunction != null && (result = this.result) != null) {
                ...
                while (result.get() == null) {
                    ...
                    U u = searchFunction.apply(p2.key, p2.val);
                    if (u == null) continue;
        ...
        public final void compute() {
            ...
            if (searchFunction != null && (result = this.result) != null) {
                ...
                while (result.get() == null) {
                    ...
                    U u = searchFunction.apply(p2.val);
                    if (u == null) continue;
                    if (!result.compareAndSet(null, u)) break;
                    this.quietlyCompleteRoot();
                    break;
        ...
        public final void compute() {
            ...
            if (searchFunction != null && (result = this.result) != null) {
                ...
                while (result.get() == null) {
                    ...
                    U u = searchFunction.apply(p2.key);
                    if (u == null) continue;
                    if (!result.compareAndSet(null, u)) break;
                    this.quietlyCompleteRoot();
                    break;
    ...
    Serializable {
        ...
        public boolean contains(Object o2) {
            ...
            Map.Entry e2;
            Object k2;
            return o2 instanceof Map.Entry && (k2 = (e2 = (Map.Entry)o2).getKey()) != null && (r2 = this.map.get(k2)) != null && (v = e2.getValue()) != null && (v == r2 || v.equals(r2));
        }
        ...
        public boolean remove(Object o2) {
            ...
            Map.Entry e2;
            Object k2;
            return o2 instanceof Map.Entry && (k2 = (e2 = (Map.Entry)o2).getKey()) != null && (v = e2.getValue()) != null && this.map.remove(k2, v);
        }
    ...
    Serializable {
        ...
        public boolean add(K e2) {
            ...
            return this.map.putVal(e2, v, true) == null;
        }
        ...
        public boolean addAll(Collection<? extends K> c2) {
            ...
            for (K e2 : c2) {
                if (this.map.putVal(e2, v, true) != null) continue;
                added = true;
            }
            return added;
        }
    ...
    implements Map.Entry<K, V> {
        ...
        public boolean equals(Object o2) {
            ...
            Map.Entry e2;
            Object k2;
            return !(!(o2 instanceof Map.Entry) || (k2 = (e2 = (Map.Entry)o2).getKey()) == null || (v = e2.getValue()) == null || k2 != this.key && !k2.equals(this.key) || v != this.val && !v.equals(this.val));
        }
    ...
    implements Iterator<Map.Entry<K, V>> {
        ...
        public final Map.Entry<K, V> next() {
            ...
            this.advance();
            return new MapEntry(k2, v, this.map);
        }
    }
    ...
    extends Node<K, V> {
         ...
         * WARNING - Removed try catching itself - possible behaviour change.
         */
        final TreeNode<K, V> putTreeVal(int h2, K k2, V v) {
            block21: {
                TreeNode<K, V> xp2;
                int dir;
                Class<?> kc2 = null;
                ...
                do {
                    if (p2 == null) {
                        this.root = new TreeNode<K, V>(h2, k2, v, null, null);
                ...
                TreeNode<K, V> x2 = new TreeNode<K, V>(h2, k2, v, f2, xp2);
                this.first = x2;
                if (f2 != null) {
                    f2.prev = x2;
                }
    ...
    implements Map.Entry<K, V> {
        ...
        public final boolean equals(Object o2) {
            ...
            Map.Entry e2;
            Object k2;
            return !(!(o2 instanceof Map.Entry) || (k2 = (e2 = (Map.Entry)o2).getKey()) == null || (v = e2.getValue()) == null || k2 != this.key && !k2.equals(this.key) || v != (u = this.val) && !v.equals(u));
        }
