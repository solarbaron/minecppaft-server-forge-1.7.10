...
public class UnixCrypt {
    ...
    private static int dEncrypt(int el, int r2, int s2, int e0, int e1, int[] sArr) {
        ...
        int u = v & e0;
        u = u ^ u << 16 ^ r2 ^ sArr[s2];
        int t2 = (v &= e1) ^ v << 16 ^ r2 ^ sArr[s2 + 1];
        t2 = t2 >>> 4 | t2 << 28;
        return el ^= SPTRANS[1][t2 & 0x3F] | SPTRANS[3][t2 >>> 8 & 0x3F] | SPTRANS[5][t2 >>> 16 & 0x3F] | SPTRANS[7][t2 >>> 24 & 0x3F] | SPTRANS[0][u & 0x3F] | SPTRANS[2][u >>> 8 & 0x3F] | SPTRANS[4][u >>> 16 & 0x3F] | SPTRANS[6][u >>> 24 & 0x3F];
    }
