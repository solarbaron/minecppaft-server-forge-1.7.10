...
public class ArrayUtils {
    ...
    public static <T> T[] removeElements(T[] array, T ... values) {
        ...
        for (Map.Entry e2 : occurrences.entrySet()) {
            ...
            for (int i2 = 0; i2 < ct2 && (found = ArrayUtils.indexOf(array, v, found)) >= 0; ++i2) {
                toRemove.set(found++);
            }
        }
    ...
    public static char[] removeElements(char[] array, char ... values) {
        ...
        BitSet toRemove = new BitSet();
        for (Map.Entry e2 : occurrences.entrySet()) {
            Character v = (Character)e2.getKey();
            int found = 0;
            int ct2 = ((MutableInt)e2.getValue()).intValue();
            for (int i2 = 0; i2 < ct2 && (found = ArrayUtils.indexOf(array, v.charValue(), found)) >= 0; ++i2) {
                toRemove.set(found++);
            }
        }
    ...
    public static float[] removeElements(float[] array, float ... values) {
        ...
        BitSet toRemove = new BitSet();
        for (Map.Entry e2 : occurrences.entrySet()) {
            Float v = (Float)e2.getKey();
            int found = 0;
            int ct2 = ((MutableInt)e2.getValue()).intValue();
            for (int i2 = 0; i2 < ct2 && (found = ArrayUtils.indexOf(array, v.floatValue(), found)) >= 0; ++i2) {
                toRemove.set(found++);
            }
        }
    ...
    public static double[] removeElements(double[] array, double ... values) {
        ...
        BitSet toRemove = new BitSet();
        for (Map.Entry e2 : occurrences.entrySet()) {
            Double v = (Double)e2.getKey();
            int found = 0;
            int ct2 = ((MutableInt)e2.getValue()).intValue();
            for (int i2 = 0; i2 < ct2 && (found = ArrayUtils.indexOf(array, (double)v, found)) >= 0; ++i2) {
                toRemove.set(found++);
            }
        }
