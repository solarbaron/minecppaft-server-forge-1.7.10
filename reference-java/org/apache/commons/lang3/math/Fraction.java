...
implements Comparable<Fraction> {
    ...
    private Fraction addSub(Fraction fraction, boolean isAdd) {
        ...
        BigInteger w = t2.divide(BigInteger.valueOf(d2 = (tmodd1 = t2.mod(BigInteger.valueOf(d1)).intValue()) == 0 ? d1 : Fraction.greatestCommonDivisor(tmodd1, d1)));
        if (w.bitLength() > 31) {
