...
abstract class MemberUtils {
    ...
    static void setAccessibleWorkaround(AccessibleObject o2) {
        if (o2 == null || o2.isAccessible()) {
            return;
        }
        Member m2 = (Member)((Object)o2);
        if (Modifier.isPublic(m2.getModifiers()) && MemberUtils.isPackageAccess(m2.getDeclaringClass().getModifiers())) {
            try {
