...
extends AbstractManager {
    ...
    public static SMTPManager getSMTPManager(String to2, String cc2, String bcc, String from, String replyTo, String subject, String protocol, String host, int port, String username, String password, boolean isDebug, String filterName, int numElements) {
        ...
        return SMTPManager.getManager(name, FACTORY, new FactoryData(to2, cc2, bcc, from, replyTo, subject, protocol, host, port, username, password, isDebug, numElements));
    }
    ...
    public void sendEvents(Layout<?> layout, LogEvent appendEvent) {
        ...
        try {
            ...
            MimeMultipart mp2 = this.getMimeMultipart(encodedBytes, headers);
            this.sendMultipartMessage(this.message, mp2);
        }
     ...
     */
    protected void sendMultipartMessage(MimeMessage message, MimeMultipart mp2) throws MessagingException {
        MimeMessage mimeMessage = message;
        synchronized (mimeMessage) {
            message.setContent((Multipart)mp2);
    ...
    private static class FactoryData {
        ...
        public FactoryData(String to2, String cc2, String bcc, String from, String replyTo, String subject, String protocol, String host, int port, String username, String password, boolean isDebug, int numElements) {
            this.to = to2;
            this.cc = cc2;
            this.bcc = bcc;
            this.from = from;
